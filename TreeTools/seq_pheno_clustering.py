...
tree_dmat, tree_schlink = tree_converter.newick(user_tree_file)
tree_labels = dendro_worker.extract_leaf_labels_newick(user_tree_file)
...
dendro_worker.save_dendrogram(tree_schlink, tree_labels, dendro_output_file_name)
